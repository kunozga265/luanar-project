...
class ArticlesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $article=Article::create([
            ...
            'title'         =>  "Investigating and Expanding Learning across Activity System Boundaries in
Improved Cook Stove Innovation Diffusion and Adoption in Malawi. A presentation at the Cleaner Cooking Camp 5-7 June 2018, Sol-Farm, Lilongwe, Malawi",
            'year'          =>  "2018",
            'abstract'      =>  null,
            'downloadCount' =>  0,
            'journal_id'    =>  null,
...
in Malawi",
            'year'          =>  "2018",
            'abstract'      =>  "The sugarcane industry is the third largest user of pesticides in Malawi. Our aim with this study was to document
pesticide use and handling practices that influence pesticide exposure among sugarcane farmers in Malawi. A
semi-structured questionnaire was administered to 55 purposively selected sugarcane farmers and 7 key informants representing 1474 farmers in Nkhata Bay, Nkhotakota and Chikwawa Districts in Malawi. Our results
...
pesticides. There is need to put in place pesticide residue monitoring programs and farmer education on commercial sugarcane production and safe pesticide use as ways of reducing pesticide exposure.",
            'downloadCount' =>  0,
            'journal_id'    =>  1,
        ]);
...
Innovation Diffusion and Adoption in Malawi",
            'year'          =>  "2018",
            'abstract'      =>  "This study investigates and expands learning within and between activity systems working with Improved
...
//        (new AppController())->attachKeywords($article,["Cook Stove"]);
        ...
        $article=Article::create([
            ...
            'title'         =>  "Child Feeding Practices and Factors (Risks)
Associated with Provision of Complementary Foods
Among Mothers of Children Age 6–23 Months in
Dedza District of Central Malawi",
            'year'          =>  "2017",
            'abstract'      =>  "Prevalence of stunting among children in Dedza district of Central Malawi affects 51.1% of underfive
children and 47.1% of children aged 6 to 23 months. Evidence shows that appropriate complementary feeding reduces stunting and leads to improved health and growth outcomes. In Dedza
district, information on factors contributing to the high prevalence of stunting among children is
nonexistent. The study was conducted to investigate infant and young child feeding practices and to
identify factors (risks) that might contribute to undernutrition. Findings of the study would assist in
identifying strategies for improving child feeding practices and nutritional status in the district. Four
community-based focus group discussions (FGDs) with mothers and caregivers were conducted to
gain a comprehensive understanding of child feeding practices and the safety of the foods given
to the children. We found that the majority of mothers and caregivers had low levels of education
and about 80% of mothers prepared complementary foods from maize flour only. Addition of other
foods such as beans, soybeans and groundnuts to complementary foods was rare. Timely initiation
of complementary feeding was practiced by 77.1% of mothers, 8.6% introduced food earlier and
14.3% introduced later than six months. About 45% of children had diarrhoea which was associated with poor hygiene practices and poor storage of complementary food. Factors leading to
poor complementary feeding included lack of food diversity at household level, increased work burden of mothers and caregivers which led to reduced feeding frequency and inadequate knowledge
of mothers to process and prepare nutritious complementary food. It is therefore recommended
that to reverse the situation, mothers and caregivers should be trained on use of energy and time
saving technologies, hygiene practices, food processing, preparation and appropriate child feeding
practices.",
            'downloadCount' =>  0,
            'journal_id'    =>  2,
        ]);
        ...
        $article=Article::create([
            ...
            'title'         =>  "RISK FACTORS ASSOCIATED WITH STUNTING AMONG INFANTS
AND YOUNG CHILDREN AGED 6 - 23 MONTHS
IN DEDZA DISTRICT OF CENTRAL MALAWI",
            'year'          =>  "2017",
            'abstract'      =>  "The prevalence of stunting is high in Malawi, affecting about one third (31.2%) of
...
spacing should form part of nutrition education.",
        ...
        $article=Article::create([
            ...
            'title'         =>  "Targeting caregivers with context specific behavior change training increased
uptake of recommended hygiene practices during food preparation and
complementary feeding in Dedza district of Central Malawi",
            'year'          =>  "2018",
            'abstract'      =>  "The effect of a targeted training intervention on uptake of recommended hygiene practices by
caregivers of children 6–23 months was assessed. A sub-sample of 40 mothers from 303
households was used for a detailed study of hygiene practices during preparation of
complementary foods after training. Mothers and caregivers were observed for 6 months and
evaluated using a questionnaire. Data were analyzed using SPSS and Chi-square test was used
to determine the differences in proportions of mothers and caregivers who adopted
recommended practices. Results showed significant increase in the proportions of mothers and
caregivers who followed recommended hygiene practices after training. There was significant
decrease in prevalence of diarrhea among the children (45% to 8.6%). It can be concluded that
targeted training on practical hands-on activities such as hand washing, cleaning of cooking and
serving utensils, covering of food and water increase adoption of recommended hygiene and
sanitation practices.",
        ...
        $article=Article::create([
            ...
            'title'         =>  "Productivity and profitability on groundnut (Arachis
hypogaea L) and maize (Zea mays L) in a semi-arid area
of southern Malawi",
            'year'          =>  "2018",
            'abstract'      =>  "In many parts of Malawi, including Balaka district in Southern Malawi, are prone to erratic rains with
...
plants m-2. Poor plant stand is suggested as a major contributor to low yields. Results from the
