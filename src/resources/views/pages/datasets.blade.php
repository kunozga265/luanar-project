                        ...
                        <div class="single-sidebar-widget" style="margin:0">
                            ...
                            <div class="recent-content" style="border: solid 1px aqua">
                                <ul>
                                    ...
                                    <li style="padding: 7px; border-bottom: solid 1px aqua; background:#2621ff;"><a href="{{route('datasets')}}"><b style="color: #FFFAFA"> <i class="mdi mdi-chevron-right"></i> Datasets</b></a></li>
