                    ...
                    <div class="event-details-content">
                        <div class="single-event-item" style="padding:0">
                            ...
                            <div class="single-event-text" style="padding:0; background-color: white">
                                                                ...
                                                                @foreach($unverifiedDatasets as $dataset)
                                                                    <li>
                                                                        ...
                                                                        <div style="display: flex">
                                                                            ...
                                                                            <form method="post" action="{{route('datasets.trash',['id'=>$dataset->id])}}">
                                                                                @csrf
                                ...
                                <div class="listing">
                                    <ol>
                                        <a href="{{route('datasets.new')}}" class="btn btn-primary" style="background: #03a100;" >Upload Dataset <i class="mdi mdi-arrow-up"></i></a>
                                        <hr>
